...
$("#objects").jqGrid({
        ...
        $(e).autocomplete({
          ...
          select: function (event, ui) {
			...
			return false;
				...
				{name:'price', index:'price', width:150, align:'left', edittype:"text",editable:true,searchoptions:{sopt:['le','lt','gt','ge','bw','eq','ne']},editrules:{required:true,number:true},editoptions: {maxlength: 10}},
				{name:'market_price', index:'market_price', width:150, align:'left', edittype:"text",editable:true,searchoptions:{sopt:['le','lt','gt','ge','bw','eq','ne']},editrules:{required:true,number:true},editoptions: {maxlength: 10}},
				...
				{name:'date', index:'date', width:200, align:'left', edittype:"text",editable:false,searchoptions:{sopt:['bw','eq','ne','cn']}},
	...
	afterSubmit: function (response) {
			...
			},},{width:360,reloadAfterSubmit:true,zIndex:99, beforeShowForm: function(form) { 
...
$("#users").jqGrid({
            ...
            datatype: 'json',
            mtype: 'POST',
            colNames:['#','Логин','Пароль','Пароль','Статус','Уровень прав','Пользователь','Телефон'],
            colModel :[
			...
			subGridRowExpanded: function(subgrid_id, row_id) {
				...
				datatype: "json",
				mtype: 'GET',
				colNames: ['#','Покупатель','Телефон','Категория','Планировка','Этажность','Цена','Статус по времени','Статус','','Дата',''],
				colModel: [
			...
			}},{width:360,reloadAfterSubmit:true, beforeShowForm: function(form) { 
			...
			}},{width:360,reloadAfterSubmit:true},{width:460,reloadAfterSubmit:true,multipleSearch:true,closeAfterSearch:true},{width:360,reloadAfterSubmit:true}).navSeparatorAdd("#pager2",{sepclass:"ui-separator",sepcontent: ''}).navSeparatorAdd("#"+pager_id,{sepclass:"ui-separator",sepcontent: ''});

$(document).ready(function () {
	...
	function getYearSellsObjects(year) {
		...
		$.ajax({
			type: "POST",
			async: false,
			url: "/app/scripts/stats/stats_getdata.php",
			data: 'q=yearsellsobjects&year='+year,
	...
	function getYearSellsObjectsPie(year) {
		$.ajax({
			...
			async: false,
			url: "/app/scripts/stats/stats_getdata.php",
			data: 'q=yearsellsobjectspie&year='+year,
			success: function(data){
	...
	function getMonthSellsObjectsPie(year,month) {
		$.ajax({
			...
			async: false,
			url: "/app/scripts/stats/stats_getdata.php",
			data: 'q=monthsellsobjectspie&month='+month+'&year='+year,
			success: function(data){
				var response=JSON.parse(data),
					datasets= [];
	...
	function getYearPriceObjects(year) {
		...
		$.ajax({
			...
			async: false,
			url: "/app/scripts/stats/stats_getdata.php",
			data: 'q=yearpriceobjects&year='+year,
			success: function(data){
				var response=JSON.parse(data),
					datasets= [];
	...
	function getYearSellsObjectsRadar(year) {
		$.ajax({
			...
			async: false,
			url: "/app/scripts/stats/stats_getdata.php",
			data: 'q=yearsellsobjectsradar&year='+year,
			success: function(data){
	...
	function getYearDynamicDB(year) {
		...
		$.ajax({
			...
			async: false,
			url: "/app/scripts/stats/stats_getdata.php",
			data: 'q=yeardynamicdb&year='+year,
			success: function(data){
